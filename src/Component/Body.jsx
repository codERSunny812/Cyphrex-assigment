...
const Body = ({ theme }) => {
  ...
  return data == null ? (<Lottie animationData={anim} height='80px' width='80px'/>) :  (
    <>
      <Flex
        ...
        p={4}
        gap="6px"
        minHeight="100vh" // Ensure the Flex container takes up the full height of the viewport
        backgroundColor={theme === 'light' ? '#F4F5F8' : '#000000'}
        color={theme === 'light' ? 'black' : 'white'}
      >
        {/* box -1 */}
        <Box  w={{ base: '100%', md: '48%', lg: '270px' }}>
